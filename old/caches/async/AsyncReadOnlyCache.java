...
public class AsyncReadOnlyCache<K, V> implements AsyncReadCache<K, V, CacheItem<K, V>> {
    ...
    public AsyncReadOnlyCache(String name, GlobalPersistenceVehicle<K, V, CacheItem<K, V>> vehicle) {
        this(name, vehicle, vehicle);
    }

    public AsyncReadOnlyCache(String name, GlobalPersistenceVehicle<K, V, CacheItem<K, V>> writeVehicle,
